...
<ul class="exp-list">
  ...
  <li class="exp-item">
    <div class="exp-text">
      ...
      <p class="exp-title">Research Intern on MLLM’s continual learning, knowledge editing, knowledge injection, evaluation and benchmarking.</p>
      <div class="exp-roles">
        <div class="exp-role">
